...
<div>
    <main class="container">
        ...
        <!-- Add one -->
        <div>
            <a class=" btn btn-outline-secondary m-2 text-decoration-none" href="{{ route('post.create')}}"><svg
        ...
        <div>
            ...
            <div class="row border  rounded m-2 p-2 w-25">
                <a class="col text-decoration-none  " href="{{ route('post.show', $post->id)}}">{{ $post->id}}
                    .
                    {{ $post->name }}</a> <br>
            </div>
            @endforeach
